...
gcc test10.c -lIL -lILU -lILUT -lglut -lGL
...
const unsigned long maxIter = 900; //30 seconds test
...
int screenShot()
{
  char outfname[255] = "/mnt/hgfs/VM_swap/streambg0/scrot", str1[10] = "";
  sprintf(str1, "%06lu", iter);
